...
const About = () => (
    <section id="about" className="container mx-auto p-8">
        <h2 className="text-4xl font-bold text-center mb-8">Sobre mi</h2>
                ...
                <div className="space-y-4">
                    <div className="space-y-3">
                        <div className="flex items-center space-x-3">
                            ...
                            <span>Ingeniero de Sistemas - Universidad Tecnologica del Peru</span>
                        </div>
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center space-x-3">
                            <FaGraduationCap className="text-blue-600 text-xl" />
                            <span>Computación e Informática - Instituto del Sur</span>
                        </div>
                        <div className="flex items-center space-x-3 pl-7">
